...
SELECT AddGeometryColumn('Positions','Geometry',4326,'POINT',2);

CREATE TABLE IF NOT EXISTS Tessellation (
  id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT
);

SELECT AddGeometryColumn('Tessellation','Element',4326,'POLYGON',2);
...
SELECT AddGeometryColumn('HeatMap','Element',4326,'POLYGON',2);